...
class Appmerce_Eway_Model_Api_Masterpass extends Appmerce_Eway_Model_Api
{
    protected $_code = Appmerce_Eway_Model_Config::METHOD_MASTERPASS;
    ...
    {
        return $this->getConfig()->getMasterpassUrl('placement');
    }
