...
class Appmerce_Eway_Model_Api_Paypal extends Appmerce_Eway_Model_Api
{
    protected $_code = Appmerce_Eway_Model_Config::METHOD_PAYPAL;
    ...
    {
        return $this->getConfig()->getPaypalUrl('placement');
    }
