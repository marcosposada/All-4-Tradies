...
Product.Config.prototype.reloadPrice = function() {
    ...
    if(childProductId){
        ...
        this.updateProductCode(childProductId);
...
Product.Config.prototype.updateProductCode = function (productId) {
    var productCode = this.config.productCode;
    if (productId && this.config.childProducts[productId].productCode) {
        productCode = this.config.childProducts[productId].productCode;
    }
    $$('span.productcode').each(function (el) {
