...
/** when a active field gets activated - set the days back to 90 */
...
/*
origTableInputDeleteItemCallback = tableInputDeleteItemCallback

tableInputDeleteItemCallback = function(obj) {
    if (origTableInputDeleteItemCallback)
        return origTableInputDeleteItemCallback(obj);
    return true;
}
*/
